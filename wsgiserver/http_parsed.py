...
class BaseRequest(object):
    ...
    def __parse_startline(self,start_line):
        """
        Parse the start line,to get the commond,path,query,http version  # query是请求的参数，一般指的是url中?后面的参数
        :param start_line:
    ...
    def getenv(self):
        ...
        environ['GATWAY_INTERFACE'] = 'CGI/1.1'
        ...
        if environ.get("HTTPS","off") in ("on","1"):  # environ是字典，第二个参数是默认值
